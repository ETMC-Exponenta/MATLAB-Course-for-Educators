classdef MATLABCourseforEducatorsUpdater < handle
    ...
    methods
        function obj = MATLABCourseforEducatorsUpdater(root)
            % Tools Constructor
            if nargin < 1
        ...
        function [uname, upath] = clone(obj)
            % Clone MATLABCourseforEducatorsUpdater class to current Project folder
            TU = MATLABCourseforEducatorsUpdater(pwd);
        ...
        function [confname, confpath] = writeconfig(obj)
            ...
            docNode.appendChild(docNode.createComment('MATLABCourseforEducatorsUpdater configuration file'));
